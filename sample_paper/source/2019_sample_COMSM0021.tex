...
\begin{enumerate}
\item{}[5 marks] How may the brain implement supervised learning? [5 marks]
...
\item{}[4 marks] What features do artificial neuronal networks trained with backprop learn (e.g. when trained to discriminate objects in images)? Why do they provide a good match to the activity of neurons in the brain? [4 marks]\\
